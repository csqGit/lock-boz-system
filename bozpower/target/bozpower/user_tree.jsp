...
<%-- <input id="username" type="text" value="${sessionScope.user.getUserName()}"> --%>
...
var treeMenu = [
	...
	{ level:1, name:"用户管理"},
	{ level:2, name:"用户信息", ico:"<%=path %>/images/icon_default.gif",
	...
	{ level:1, name:"日志管理"},
	{ level:2, name:"日志查询", ico:"<%=path %>/images/icon_default.gif",
		link:"<%=path %>/pcLog/selectLogList?page=1"}
];
</script>
